...
/**
 * Egg move editor for Generation 6 games (X/Y & OR/AS).
...
public class Gen6EggMovesSheetPanel extends JPanel {
    ...
    public Gen6EggMovesSheetPanel(RomHandler romHandler) {
    ...
    private void exportToCSV() {
        stopEditing();
        EditorUtils.exportTableToCSV(this, tableModel, "Egg Moves (Gen 6)");
    }

    private void importFromCSV() {
        stopEditing();
        EditorUtils.CsvData csvData = EditorUtils.chooseCsvFile(this, "Egg Moves (Gen 6)");
        if (csvData == null) {
            return;
        }
