...
/**
 * Moves Sheet editor for Generation 6 games (XY/ORAS).
 * Mirrors PokEditor's move table so every ROM field stays editable.
 */
public class Gen6MovesSheetPanel extends JPanel {
    ...
    public Gen6MovesSheetPanel(RomHandler romHandler) {
    ...
    private void setupMainTableColumns() {
        ...
        for (int i = 0; i < mainTable.getColumnCount(); i++) {
            ...
            if (modelCol == MovesDataTableModel.COL_EFFECT) {
                column.setCellRenderer(new EffectCellRenderer());
            } else if (modelCol == MovesDataTableModel.COL_CATEGORY) {
    ...
    private void exportToCSV() {
        stopEditing();
        EditorUtils.exportTableToCSV(this, tableModel, "Moves Sheet (Gen 6)");
    }
    ...
    private void importFromCSV() {
        ...
        EditorUtils.CsvData csvData = EditorUtils.chooseCsvFile(this, "Moves Sheet (Gen 6)");
        if (csvData == null) {
            return;
        }
    ...
    private class EffectCellRenderer extends DefaultTableCellRenderer {
        EffectCellRenderer() {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            String label = tableModel.effectLabel(modelRow);
    ...
    private class TypeComboBoxEditor extends DefaultCellEditor {
        public TypeComboBoxEditor(RomHandler romHandler) {
            ...
            // Uses the ROM's type table so XY/ORAS (and mods) expose every available type
    ...
    private static class MovesDataTableModel extends AbstractTableModel {
        ...
        private static final String[] COLUMN_NAMES = {
                ...
                "<html><center>Min Effect<br>Duration</center></html>",
                "<html><center>Max Effect<br>Duration</center></html>",
        ...
        String effectLabel(int rowIndex) {
            return "";
        }
