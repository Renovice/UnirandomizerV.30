 ...
 */
public class TMsSheetPanel extends JPanel {
    ...
    public TMsSheetPanel(RomHandler romHandler) {
    ...
    private List<String> collectTmChangesForLog() {
        ...
        for (Species species : pokemonList) {
            ...
            if (!additions.isEmpty() || !removals.isEmpty()) {
                ...
                changes.add(String.format("%s: %s", species.getFullName(), String.join("; ", segments)));
            }
        }
    ...
    private void setupMainTableColumns() {
        // Set wider columns so TM names are readable
    ...
    private static class CheckboxRenderer extends JCheckBox implements TableCellRenderer {
        public CheckboxRenderer() {
            ...
            // Don't override the default checkbox icons - let JCheckBox handle
        ...
        public TMCompatibilityTableModel(List<Species> pokemonList, List<Move> moveList,
            ...
            for (int i = 0; i < tmCount; i++) {
                ...
                String moveName = moveIndex < moveList.size() && moveList.get(moveIndex) != null
                        ...
                        : "???";
                columnNames[2 + i] = String.format("<html>TM%02d<br>%s</html>", i + 1, escapeHtml(moveName));
            }
            ...
            for (int i = 0; i < hmCount; i++) {
                ...
                String moveName = moveIndex < moveList.size() && moveList.get(moveIndex) != null
                        ? moveList.get(moveIndex).name
                        : "???";
                columnNames[2 + tmCount + i] = String.format("<html>HM%02d<br>%s</html>", i + 1, escapeHtml(moveName));
            }
        }
        ...
        public Object getValueAt(int row, int col) {
            ...
            switch (col) {
                ...
                default:
                    ...
                    // TM/HM compatibility array is 1-indexed (index 0 is unused) for both Gen4 and
                    // Gen5
                    // Array size: boolean[tmCount + hmCount + 1]
                    // Data stored at indices 1 through (tmCount + hmCount)
                    // Column layout: 0=ID, 1=Name, 2=TM01, 3=TM02, etc.
                    // Column 2 should read index 1 (TM01), so we need compat[col - 1]
