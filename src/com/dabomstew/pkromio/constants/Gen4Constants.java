...
public class Gen4Constants {
    ...
    // Additional base stat offsets for complete Gen 4 personal data structure
    public static final int bsExpYieldOffset = 9,
            bsHPEVOffset = 10, // EV yields are packed into bytes 10-11 (see bit masking in Gen4RomHandler)
            bsHatchCyclesOffset = 17, bsBaseHappinessOffset = 18,
            bsEggGroup1Offset = 20, bsEggGroup2Offset = 21,
            bsRunChanceOffset = 24, bsColorOffset = 25, bsFlipOffset = 26;
