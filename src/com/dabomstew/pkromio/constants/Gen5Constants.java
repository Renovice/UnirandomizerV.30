...
public class Gen5Constants {
    ...
    // Pokemon Base Stats byte offsets (complete with ALL fields from FrostsGen5Editor)
    public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2, bsSpeedOffset = 3,
            bsSpAtkOffset = 4, bsSpDefOffset = 5, bsPrimaryTypeOffset = 6, bsSecondaryTypeOffset = 7,
            bsCatchRateOffset = 8, bsEvolutionStageOffset = 9,
            bsEVYieldOffset = 10, // EV yields are packed into bytes 10-11 (see bit masking)
            bsCommonHeldItemOffset = 12, bsRareHeldItemOffset = 14,
            bsDarkGrassHeldItemOffset = 16, bsGenderRatioOffset = 18,
            bsHatchCounterOffset = 19, bsBaseHappinessOffset = 20, bsGrowthCurveOffset = 21,
            ...
            bsPokedexColorOffset = 33, bsExpYieldOffset = 34,
            bsHeightOffset = 36, bsWeightOffset = 38,
            bsTMHMCompatOffset = 40, // TM/HM compatibility (101 TMs, bit-packed)
            bsMiscTutorsOffset = 56, // Misc Tutors (7 moves)
            bsDriftveilTutorsOffset = 60, // Driftveil Tutors (15 moves)
            bsLentimasTutorsOffset = 64, // Lentimas Tutors (17 moves)
            bsHumilauTutorsOffset = 68, // Humilau Tutors (13 moves)
            bsNacreneTutorsOffset = 72, // Nacrene Tutors (15 moves)
            bsMTCompatOffset = 60; // Legacy name for move tutors
    ...
    public static final int bw1MoveTutorCount = 7;
    public static final int[] bw1MoveTutorMoveIds = {
            MoveIDs.grassPledge,
            MoveIDs.firePledge,
            MoveIDs.waterPledge,
            MoveIDs.frenzyPlant,
...
//    public static final Map<Integer, String> bw1ShopIndex = new HashMap<Integer, String>() {1:"Check"};
    ...
    /**
     * Overload of typeToByte that handles Fairy type for ROM hacks.
     * For modded Gen 5 ROMs with Fairy type (like Blaze Black 2 Redux),
     * Fairy is mapped to byte 0x11, matching Gen 6+ implementation.
     *
     * @param type The type to convert
     * @param hasFairyType Whether this ROM has Fairy type support
     * @return The byte value representing this type in the ROM
     */
    public static byte typeToByte(Type type, boolean hasFairyType) {
        if (hasFairyType && type == Type.FAIRY) {
            return 0x11; // Fairy type byte in modded Gen 5 ROMs
        }
        return typeToByte(type); // Use standard Gen 5 mapping for everything else
    }

    /**
     * Converts a type byte back to a Type enum.
     * Supports both vanilla Gen 5 (17 types) and modded ROMs with Fairy (18 types).
     *
     * @param typeByte The byte value from the ROM
     * @param hasFairyType Whether this ROM has Fairy type support
     * @return The Type enum, or null if invalid
     */
    public static Type byteToType(byte typeByte, boolean hasFairyType) {
        int value = typeByte & 0xFF;
        switch (value) {
            case 0x00: return Type.NORMAL;
            case 0x01: return Type.FIGHTING;
            case 0x02: return Type.FLYING;
            case 0x03: return Type.POISON;
            case 0x04: return Type.GROUND;
            case 0x05: return Type.ROCK;
            case 0x06: return Type.BUG;
            case 0x07: return Type.GHOST;
            case 0x08: return Type.STEEL;
            case 0x09: return Type.FIRE;
            case 0x0A: return Type.WATER;
            case 0x0B: return Type.GRASS;
            case 0x0C: return Type.ELECTRIC;
            case 0x0D: return Type.PSYCHIC;
            case 0x0E: return Type.ICE;
            case 0x0F: return Type.DRAGON;
            case 0x10: return Type.DARK;
            case 0x11: return hasFairyType ? Type.FAIRY : null;
            default: return null;
        }
    }
