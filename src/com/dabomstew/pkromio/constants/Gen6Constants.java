...
public class Gen6Constants {
    ...
    public static final int bsHPOffset = 0, bsAttackOffset = 1, bsDefenseOffset = 2, bsSpeedOffset = 3,
            ...
            bsCatchRateOffset = 8, bsEvoStageOffset = 9, bsEVYieldOffset = 10,
            bsCommonHeldItemOffset = 12, bsRareHeldItemOffset = 14, bsDarkGrassHeldItemOffset = 16,
            bsGenderOffset = 18, bsHatchCyclesOffset = 19, bsBaseHappinessOffset = 20, bsGrowthCurveOffset = 21,
            bsEggGroup1Offset = 22, bsEggGroup2Offset = 23, bsAbility1Offset = 24, bsAbility2Offset = 25,
            bsAbility3Offset = 26, bsEscapeRateOffset = 27, bsFormeOffset = 28, bsFormeSpriteOffset = 30,
            bsFormeCountOffset = 32, bsColorFlagsOffset = 33, bsBaseEXPOffset = 34,
