...
public class Move implements Comparable<Move> {
    ...
    public int minTrapTurns;
    public int maxTrapTurns;
    public int statusEffect; // raw status effect ID
    public int categoryQuality;
    ...
    // Additional move flags from Gen 4 move data
    public boolean isProtectedFromProtect; // Can be blocked by Protect
    public boolean isMagicCoatAffected; // Can be reflected by Magic Coat
    public boolean isSnatchAffected; // Can be stolen by Snatch
    public boolean isMirrorMoveAffected; // Can be copied by Mirror Move
    public boolean isFlinchMove; // Can trigger King's Rock / triggers flinch
    public boolean hidesHpBars; // Hides HP bars during move animation
    public boolean removesTargetShadow; // Removes target's shadow (Sky Drop, etc.)
    public boolean groundedByGravity;
    public boolean defrostsUser;
    public boolean hitsNonAdjacent;
    public boolean isHealingMove;
    public boolean bypassesSubstitute;
    public boolean extraFlag1;
    public boolean extraFlag2;
    public int secondaryEffectChance; // Effect chance percentage (0-100)
    public int contestEffect; // Contest effect ID
    public int contestType; // Contest type (Cool, Beauty, Cute, etc.)
    ...
    public Move(Move original) {
        ...
        this.minHits = original.minHits;
        this.maxHits = original.maxHits;
        this.minTrapTurns = original.minTrapTurns;
        this.maxTrapTurns = original.maxTrapTurns;
        this.statusEffect = original.statusEffect;
        this.categoryQuality = original.categoryQuality;
        this.criticalStage = original.criticalStage;
        ...
        this.isProtectedFromProtect = original.isProtectedFromProtect;
        this.isMagicCoatAffected = original.isMagicCoatAffected;
        this.isSnatchAffected = original.isSnatchAffected;
        this.isMirrorMoveAffected = original.isMirrorMoveAffected;
        this.isFlinchMove = original.isFlinchMove;
        this.hidesHpBars = original.hidesHpBars;
        this.removesTargetShadow = original.removesTargetShadow;
        this.groundedByGravity = original.groundedByGravity;
        this.defrostsUser = original.defrostsUser;
        this.hitsNonAdjacent = original.hitsNonAdjacent;
        this.isHealingMove = original.isHealingMove;
        this.bypassesSubstitute = original.bypassesSubstitute;
        this.extraFlag1 = original.extraFlag1;
        this.extraFlag2 = original.extraFlag2;
        this.secondaryEffectChance = original.secondaryEffectChance;
        this.contestEffect = original.contestEffect;
        this.contestType = original.contestType;
    }
