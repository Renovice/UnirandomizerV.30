...
public class Species implements Comparable<Species> {
    ...
    private int spatkEvYield;
    private int spdefEvYield;
    private int speedEvYield;

    // Additional Pokemon data fields
    private int baseHappiness = 70; // Default to 70
    private int eggGroup1;
    private int eggGroup2;
    private int hatchCounter; // Egg cycles / hatch counter (Gen 5+)
    private int height; // Height in decimeters (Gen 5+)
    private int weight; // Weight in hectograms (Gen 5+)
    private int runChance;
    private int color; // Pokedex color
    private boolean flip; // Sprite flip flag
    ...
    public int getAttackEvYield() {
        return attackEvYield;
    }

    public void setAttackEvYield(int attackEvYield) {
        this.attackEvYield = attackEvYield;
    }

    public int getDefenseEvYield() {
        return defenseEvYield;
    }

    public void setDefenseEvYield(int defenseEvYield) {
    ...
    // Additional Pokemon Data Getters and Setters
    ...
    // Getters and setters for Gen 5 additional fields
